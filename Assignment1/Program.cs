...
namespace Assignment1
{
    class Program
    {
        ...
        static int user_entered_length;
        static int user_entered_width;

        public static void Main(string[] args)
        {
            Program.getDimensions();
            Program.getRectangleMenu();
        }
        ...
        public static void getDimensions()
        {
            ...
            catch (Exception ex)
            {
                ...
                Console.WriteLine("Please try again and provide any valid number (i.e., should be greater than 0) \n");
                Program.getDimensions();
            }
        ...
        public static void getRectangleMenu()
        {
            try
            {
               ...
               choice != 6 || choice != 7)
                ...
                Console.WriteLine();
                    ...
                    else
                    {
                        ...
                        Console.WriteLine("Please try again and select a valid menu option between 1-7 \n");
                        break;
                    }
